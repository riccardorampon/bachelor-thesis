...
%\usepackage[style=numeric-comp,useprefix,backend=biber]{biber}
...
% ABSTRACT ----------------------------------------------------------------------------
	...
	\input{abstract.tex} % importa il capitolo dal corrispondente file
	...
	\input{approccio.tex} % importa il capitolo dal corrispondente file

	% MOD. TOPOLOGIA -------------------------------------------------------------------------
	\clearpage{\pagestyle{plain}\cleardoublepage} % inizia il nuovo capitolo su di una pagina dispari
	\chapter{Modifiche della topologia proposte} % nome capitolo
	\label{chapter:terzo} % label capitolo
	\input{modifica_topologia.tex} % importa il capitolo dal corrispondente file

	% OTTIMIZZATORI -------------------------------------------------------------------------
	\clearpage{\pagestyle{plain}\cleardoublepage} % inizia il nuovo capitolo su di una pagina dispari
	\chapter{Metodi di ottimizzazione} % nome capitolo
	\label{chapter:quarto} % label capitolo
	\input{ottimizzatori.tex} % importa il capitolo dal corrispondente file
